...
namespace pf
{
    ...
    public:
        RequestDrawDebugDotEvent(ke::Point2DInt32 position = {}, float radius = 1.0f, ke::Color color = ke::Color::GREEN)
        ...
        inline const ke::Point2DInt32 & getPosition() const { return this->position; }

    private:
        ke::Point2DInt32 position;
        float radius = 0.0f;
